<div class="flex flex-col justify-center p-6 text-center border rounded">
    <div>
        <svg class="max-w-sm mx-auto" viewBox="0 0 1062 870" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="No Results">
                ...
                <g id="search">
                    ...
                    <g id="search_2">
                        ...
                        <path id="Fill 25" fill-rule="evenodd" clip-rule="evenodd" d="M819.677 686.825L817.636 688.866C804.131 702.378 782.016 702.378 768.505 688.866L643.811 564.172L694.983 513L819.677 637.694C833.188 651.206 833.188 673.313 819.677 686.825Z" fill="url(#paint0_linear_86_9556)"/>
                        ...
                        <path id="Fill 31" fill-rule="evenodd" clip-rule="evenodd" d="M697.811 514.76L645.572 567L637.811 559.24L690.049 507L697.811 514.76Z" fill="url(#paint1_linear_86_9556)"/>
            ...
            <defs>
                <linearGradient id="paint0_linear_86_9556" x1="736.811" y1="420" x2="550.811" y2="606" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#FF8960"/>
                    <stop offset="1" stop-color="#FF62A5"/>
                </linearGradient>
                <linearGradient id="paint1_linear_86_9556" x1="667.811" y1="477" x2="607.811" y2="537" gradientUnits="userSpaceOnUse">
    ...
    <h4 class="text-2xl font-bold">No articles found</h4>
    <p class="text-gray-400">We don't have any recent articles, try to search another articles.</p>
</div>